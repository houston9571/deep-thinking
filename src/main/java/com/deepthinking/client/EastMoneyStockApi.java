...
public interface EastMoneyStockApi {
    ...
    /**
     * 股票成交明细,最近的实时快照
     * 时间, 价格, 成交量, 方向(1买2卖), 其它
     * http://push2delay.eastmoney.com/api/qt/stock/details/get?secid=1.600089&fields1=f1,f2,f3,f4,f5&fields2=f51,f52,f53,f54,f55&pos=-100
     */
    JSONObject getStockTick(@Var("tradeDate") String tradeDate, @Var("stockCode") String stockCode);
